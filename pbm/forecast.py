...
def save_predictions_csv(Y_pred: np.ndarray, wells: list, name: str, out_dir: str, T_pref: int, T: int) -> None:
...
def plot_example(idx: int, title: str, ytrue: np.ndarray, ypred: np.ndarray, T_pref: int, T: int, out_dir: str) -> str:
